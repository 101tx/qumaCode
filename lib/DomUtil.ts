class DomUtil {
    ...
    public static init() {
        ...
        let bt = document.getElementById("cmdCode_display");
        ...
        let s = document.getElementsByClassName("cmdCode_bt");
        ...
        let clear = document.getElementById("gm_clear");
        clear.onclick = function () {
            codeEditorTool.editor.setValue("//请输入代码;");
          backd.play();
        };

        let start = document.getElementById("gm_start");
        ...
        ;
        let runAction = document.getElementById("gm_action");
